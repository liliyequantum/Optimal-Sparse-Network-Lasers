function GA_island(type_freq_disorder, num_rng_w, num_rng_ga,...
    popSize, numGenerations, numIslands, case_type)
    ...
    % connectivity =0.4;
    % num_rng_ga = 0;
    % popSize = 4; % total popSize in all islands, popSize/numIsland should be even
    % numGenerations = 2;
    ...
    mkdir('data')
    save(['./data/updated_GA_island_',type_freq_disorder,...
        '_rngw_',num2str(num_rng_w), '_rngga_',num2str(num_rng_ga),...
        '_popSize_',num2str(popSize),'_numGen_',num2str(numGenerations),...
        '_numIs_',num2str(numIslands),'_case_type_',case_type,'.mat'],'-v7.3');
end
