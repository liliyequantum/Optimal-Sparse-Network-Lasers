function [sol, t_sol, E_sol, N_sol, Iss, Nss, S, ave_S] = Diode_Lang_Kobayashi_Eq_specify_alpha(alpha, method, detuning, adjMatrix)
 % clear;clc;
    maxNumCompThreads(1);
    ...
    params.alpha = alpha;% linewidth enhancement factor
    ...
    elseif strcmp(method,  'abm4milshtein')
        % abm
        [t_cell, E_cell, N_cell, Iss_cell, Nss_cell] = lk_abm4milshtein(h_abm, noise_switch,...
            params,initial_state_noise_switch);
        sol = 1;
    end
