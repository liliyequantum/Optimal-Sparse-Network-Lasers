function rescale_all2all_coupling_scan(method, M, num_rng_w, std_w) 
...
d_array = 0:0.5:1;%[0:0.05:3, 3.2:0.2:5];
...
for i = 1:num_d
    ...
    K_cell{i, 1} = params.coupling_matrix;
    if strcmp(method, 'dde23')
        % dde23
    ...
    disp(['progress: ', num2str(i/num_d)])
end
toc

clear t_sol E_sol t_cell E_cell
mkdir('data')
save(['./data/diode_data_M_',num2str(M),'_num_rng_w_', num2str(num_rng_w),...
