function rescale_connectivity_scan_run_pump(method, coupling_connectivity, M, pump_factor)
% 0<=coupling_connectivity<=1
    ...
    params.j0 = 1/N_bar * pump_factor * params.gamma_n * (params.N0 * N_bar + params.gamma / params.g); % pump current, ns^-1
    ...
    save(['./data/pump_',num2str(pump_factor),'_connectivity_',num2str(coupling_connectivity),...
        '_M_',num2str(M),'.mat'],'ave_S_array','coupling_matrix_cell')
