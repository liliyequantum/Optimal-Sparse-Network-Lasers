...
figure(1);clf;
% set(gcf, 'Position', [100, 100, 600, 300]); % Set the figure position and size
...
plot([0,1],max_all2all*ones(1,2),'Color',bright_blue, 'LineStyle', '--','LineWidth',3); hold on;
% plot([0.4,0.4],[0,1],'Color',[0,0,0,0.7], 'LineStyle', '--','LineWidth',1.5); hold on;
