function figS5b_1_rescale_connectivity_scan_run_parameter_r2(method, coupling_connectivity, M)
% 0<=coupling_connectivity<=1
    ...
    ave_r2_array = zeros(num_repeat,1);
    tic
    for i = 1:num_repeat
        ...
        ave_r2_array(i) = sum(r2(index:end))./length(t_sol(index:end));
    ...
    save(['./data/diode_data_connectivity_',num2str(coupling_connectivity),...
        '_M_',num2str(M),'parameter_r2.mat'],'ave_r2_array','coupling_matrix_cell')
